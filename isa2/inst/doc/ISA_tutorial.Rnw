...
png("graphics/blockplot.png", 800, 600)
@ 
<<blockplot>>=
...
\begin{figure}
\centering
\includegraphics[width=0.6\textwidth]{graphics/blockplot}
...
\begin{figure}
\centering
\includegraphics{graphics/tenmods}
...
\begin{figure}
\centering
\includegraphics[width=0.6\textwidth]{graphics/othermods}
...
\begin{figure}
\centering
\includegraphics[width=0.5\textwidth]{graphics/drawheatmap}
...
png("graphics/noise.png", width=800, height=600)
@ 
<<noiseplot>>=
...
\begin{figure}
  \centering
  \includegraphics[width=\textwidth]{graphics/noise}
...
png("graphics/overlapplot.png", 800, 600)
@ 
<<overlapplot>>=
...
\begin{figure}
\centering
\includegraphics{graphics/overlapplot}
