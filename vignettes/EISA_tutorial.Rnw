...
The \Rfunction{autogen.table} function creates a summary of a set of
ISA modules, as an HTML table. The summary includes the results of the
enrichment calculations as well.
<<HTML1>>=
